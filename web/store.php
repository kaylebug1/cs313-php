...
<div class="jumbotron cane"><h1><a href='store.php'>Candy Cane Craze</a></h1>
	<a href="viewCart.php">
		<img border="0" alt="veiw cart" src="cart.png" class="cart">
	</a>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-3">
			<img src="candyclassic.jpg" class="img-thumbnail pic" alt="classic candy cane" width="200px" height="200px">
			<div class="caption"><p>Clasic Candy Cane</p>
			<button name="classic" type="submit" value="1">Add to cart</button>
			</div>
		</div>
		<div class="col-md-3">
			<img src="candystick.jpg" class="img-thumbnail pic" alt="classic candy stick" width="200px" height="200px">
			<div class="caption"><p>Candy Cane Stick</p>
			<button name="stick" type="submit" value="1" >Add to Cart</button> 
			</div>
		</div>
		<div class="col-md-3">
		<img src="candyj.jpg" class="img-thumbnail pic" alt="candy j" width="200px" height="200px">
			<div class="caption"><p>Candy J</p>
			<button type="submit" name="j" value="1">Add to cart</button>
			</div>
		</div>
		<div class="col-md-3">
			<img src="candycircle.jpg" class="img-thumbnail pic" alt="classic circle" width="200px" height="200px">
	...
	<div class="row">
		<div class="col-md-3">
			<img src="candygummy.jpg" class="img-thumbnail pic" alt="candy cane gummy" width="200px" height="200px">
			<div class="caption"><p>Candy Cane Gummy</p>
			<button type="submit" name="gummy" value="1">Add to cart</button>
			</div>
		</div>
		<div class="col-md-3">
			<img src="candytree.jpg" class="img-thumbnail pic" alt="candy tree" width="200px" height="200px">
			<div class="caption"><p>Candy Cane Tree</p>
			<button type="submit" name="tree" value="1">Add to cart</button>
			</div>
		</div>
		<div class="col-md-3">
		<img src="candyshank.jpg" class="img-thumbnail pic" alt="candy shank" width="200px" height="200px">
			<div class="caption"><p>Candy Shank</p>
			<button type="submit" name="shank" value="1">Add to cart</button>
			</div>
		</div>
		<div class="col-md-3">
			<img src="candyheart.jpg" class="img-thumbnail pic" alt="candy cane heart" width="200px" height="200px">
